...
veh  = VehicleModelPublic(
    str(pathlib.Path(r'D:\chrome-download\5\5.4\vehiclemodel_public_0326_win64_new.dll').absolute())
)
...
ani = FuncAnimation(fig_anim, update, frames=len(X_hist),
